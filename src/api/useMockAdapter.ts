...
const useMockAdapter = () => {
  ...
  // comments
  mock
    .onGet('/api/comments', { params: { page: 1 } })
    .reply(200, commentsPage1);

  mock.onGet('/api/comments', { params: { page: 2 } }).networkErrorOnce();
  mock
    .onGet('/api/comments', { params: { page: 2 } })
    .reply(200, commentsPage2);

  mock
    .onGet('/api/comments', { params: { page: 3 } })
    .reply(200, commentsPage3);
};
